...
//line stdlib/semver/semver_test.kuki:166
	for _, tc := range cases {
//line stdlib/semver/semver_test.kuki:167
		t.Run(tc.name, func(t *testing.T) {
//line stdlib/semver/semver_test.kuki:168
			got, err := semver.Highest(tc.tags)
//line stdlib/semver/semver_test.kuki:169
			if tc.wantErr {
//line stdlib/semver/semver_test.kuki:170
				test.AssertError(t, err)
			} else {
//line stdlib/semver/semver_test.kuki:172
				test.AssertNoError(t, err)
//line stdlib/semver/semver_test.kuki:173
				test.AssertEqual(t, got, tc.want)
			}
		})
	}
